			...
			>
				<div class="card p-4 w-full text-token space-y-4">
					...
					<div class="grid grid-cols-3 gap-4 pt-2 items-center justify-center">
						...
						<input class="input" title="Peso" type="text" placeholder="Kg" />
					</div>
					<hr />
					...
					<div class="grid grid-cols-3 gap-4 pt-2 items-center justify-center">
						...
						<input class="input" title="Detalles" type="text" placeholder="IMC" />
					</div>
					<hr />
					...
					<div class="grid grid-cols-3 gap-4 pt-2 items-center justify-center">
						...
						<input class="input" title="txNutricion" type="text" placeholder="TX Nutricion" />
					</div>
					<hr />
